...
<script>
	...
	var ltt=12.9667, lgt=77.5667, zoom=10, input, KeyWord, action=100;
	var mapOptions;
	var map;
	var geocoder;
	var marker;
	...
	function initialize() {
      ...
      var infowindow = new google.maps.InfoWindow({
		...
		//google.maps.event.addDomListener(document.getElementById('map-canvas'), 'mouseover', initialize);
...
-->
	...
	<div>
	<p id="hd"><h1>MapAssist - Search By Voice</h1></p>	
	</div>

	<div id="panel">
		<input type="text" id="keyWord" x-webkit-speech
			onmouseout="perfomActionCommands()" />
